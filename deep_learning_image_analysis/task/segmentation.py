...
def CellSegmentation(frames,channel,file_name) :
    ...
    #    pl_.imshow(pred,cmap="gray")
        pl_.imsave("output/"+str(file_name)+"/segmentation/cell/frame"+str(idx)+".jpg",pred,cmap="gray")
...
#        prediction = model.predict(bright_frames)
    ...
    #    pl_.figure()
    #    pl_.imshow(pred,cmap="gray")
        pl_.imsave("output/"+str(file_name)+"/segmentation/nucl/frame"+str(idx)+".jpg",pred,cmap="gray")
